...
var entryFactory = require('../../../../factory/EntryFactory'),
    script = require('./ScriptHska')('scriptFormat', 'value', true);
...
module.exports = function(element, bpmnFactory, options) {
  ...
  entries.push({
    ...
    isScript: function(element, node) {
      var bo = getSelected(element, node);
      var shouldShow = bo &&
            isScript(bo.definition) &&
            bo.definition.scriptFormat === 'freemarker' &&
            // bo.get('ScriptType') === 'script';
            true;

      if (bo) {
        console.log(bo.definition);
        console.log(bo.get('Script Format'));
        console.log(bo.get('scriptFormat'));
        console.log(bo.get('Script_Format'));
      }
      return shouldShow;
    },
