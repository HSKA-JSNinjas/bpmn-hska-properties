...
var implementationType = require('./implementation/ImplementationType'),
    ...
    delegateHska       = require('./implementation/DelegateHska');

var entryFactory = require('../../../factory/EntryFactory');
var selectEntryFactory = require('../../../factory/selectEntryFactory');
...
module.exports = function(group, element, bpmnFactory) {
  ...
  group.entries = group.entries.concat(delegateHska(element, bpmnFactory, {
    getBusinessObject: getBusinessObject,
    getImplementationType: getImplementationType
  }));
