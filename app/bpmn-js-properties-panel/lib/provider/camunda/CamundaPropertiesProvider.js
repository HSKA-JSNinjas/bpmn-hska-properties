...
var serviceTaskDelegateProps = require('./parts/ServiceTaskDelegateProps'),
    serviceTaskDelegatePropsHska = require('./parts/serviceTaskDelegatePropsHska'),
    userTaskProps = require('./parts/UserTaskProps'),
    userTaskPropsHska = require('./parts/userTaskPropsHska'),
    ...
    sequenceFlowPropsHska = require('./parts/SequenceFlowPropsHska'),
    executionListenerProps = require('./parts/ExecutionListenerProps'),
    scriptProps = require('./parts/ScriptTaskProps'),
    scriptPropsHska = require('./parts/ScriptTaskPropsHska'),
...
var inputOutput = require('./parts/InputOutputProps'),
    ...
    inputOutputParameterHska = require('./parts/InputOutputParameterPropsHska');
...
var groups = [];
  ...
  inputOutputParameterHska(inputOutputParameterGroup, element, bpmnFactory, options);
  groups.push(inputOutputParameterGroup);
  ...
  userTaskPropsHska(detailsGroup, element);
  serviceTaskDelegatePropsHska(detailsGroup, element, bpmnFactory);
  sequenceFlowPropsHska(detailsGroup, element, bpmnFactory);

  scriptPropsHska(detailsGroup, element, bpmnFactory);
  ...
  this.getTabs = function(element) {
    ...
    var hskaTab = {
      ...
      groups: createHskaTabGroups(
        element, bpmnFactory, elementRegistry, elementTemplates
      )
    }
